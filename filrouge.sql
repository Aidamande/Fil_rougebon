...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 24 août 2022 à 20:28
...
CREATE TABLE `users` (
  ...
  `numerocnib` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `role_id`, `name`, `prenom`, `email`, `avatar`, `numerocnib`, `email_verified_at`, `password`, `remember_token`, `settings`, `created_at`, `updated_at`) VALUES
(1, NULL, 'MANDE', 'Aida', 'aidamande@gmail.com', 'users/default.png', 'B8896541', NULL, '$2y$10$A8aZ5Jy/CccxXnfr4sEuqev.Kzf02znyTq9wlMywejqdmjuKDheiu', NULL, NULL, '2022-08-23 12:22:07', '2022-08-23 12:22:07'),
(2, NULL, 'VALEA', 'Cynthia', 'aim@gmail.com', 'users/default.png', 'B885641', NULL, '$2y$10$4IVCv2Y6kvreR8S4v7cQHeHEXlG3AERHbxjvbOksxyNVG1hrbcsTu', NULL, NULL, '2022-08-23 16:35:03', '2022-08-23 16:35:03');
